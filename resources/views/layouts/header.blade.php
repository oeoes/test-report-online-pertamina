    ...
    <div id="header" class="page-header ">
        <div class="navbar navbar-expand-lg">
            ...
            <a href="" class="navbar-brand d-lg-none">
                ...
                <img src="{{ asset('images/logo.png') }}" alt="" srcset="" style="width: 85px;">
            ...
            <div class="collapse navbar-collapse order-2 order-lg-1" id="navbarToggler">
                <form class="input-group m-2 my-lg-0 ">
                    ...
                    <input type="text" class="form-control no-border no-shadow no-bg typeahead" placeholder="Search components..." data-plugin="typeahead" data-api="{{ asset('basik/assets/api/menu.json') }}">
                </form>
            </div>
            <ul class="nav navbar-menu order-1 order-lg-2">
                ...
                <li class="nav-item dropdown">
                    <a href="#" data-toggle="dropdown" class="nav-link d-flex align-items-center px-2 text-color">
                        <span data-toggle="tooltip" title="Logged in as {{ auth()->user()->email }}" class="avatar w-24" style="margin: -2px;"><img src="{{ asset('images/male.svg') }}" alt="..."></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right w mt-3 animate fadeIn">
                        ...
                        <a class="dropdown-item" href="{{ route('user.signout') }}">Sign out</a>
                    </div>
                </li>
                <!-- Navarbar toggle btn -->
